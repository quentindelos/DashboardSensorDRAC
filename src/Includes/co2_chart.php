...
<body>
    ...
    <main>
        <button id="retour-button" onclick="goBack()" style="color: #000191;">✖</button>
        ...
        <script>
            ...
            // Code PHP pour récupérer les données de CO2 et les mettre à jour dans le graphique
            <?php
                ...
                try {
                    ...
                    $sql_co2 = "SELECT DATE_FORMAT(TIME, '%H:%i') AS TIME, MESURE FROM `CAPTEUR` WHERE ID_TYPE_CAPTEUR = 'C' AND DATE(TIME) = CURDATE() ORDER BY ID_CAPTEUR";
                    ...
                    echo "chart.data.labels = " . json_encode($co2_data['TIME']) . ";";
                    echo "chart.data.datasets[0].data = " . json_encode($co2_data['MESURE']) . ";";
                    echo "chart.update();";
