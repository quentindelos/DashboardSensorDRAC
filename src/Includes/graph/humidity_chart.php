...
<body>
    ...
    <main>
        ...
        <script>
            ...
            // Code PHP pour récupérer les données d'humidité et les mettre à jour dans le graphique
            <?php
                ...
                try {
                    ...
                    $sql_humidity = "SELECT DATE_FORMAT(TIME, '%H:%i') AS TIME, MESURE FROM `CAPTEUR` WHERE ID_TYPE_CAPTEUR = 'H' AND DATE(TIME) = CURDATE() ORDER BY ID_CAPTEUR";
                    ...
                    echo "chart.data.labels = " . json_encode($humidity_data['TIME']) . ";";
                    echo "chart.data.datasets[0].data = " . json_encode($humidity_data['MESURE']) . ";";
                    echo "chart.update();";
